...
def pabx(request):
	...
	context = RequestContext(request, {'ramais_sip':ramais_sip, 'exten':exten, 'trunk':trunk, 'info':info, 'perc': perc, 'total': total, 'stats_AN':stats_AN, 'stats_NO':stats_NO,'cidade':cidade,'portados_s':portados_s,
