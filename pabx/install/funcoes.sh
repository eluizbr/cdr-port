...
mysql -u "$USER_BANCO_MASTER" -p"$SENHA_BANCO_MASTER" -e "GRANT ALL PRIVILEGES ON $NOME_BANCO.* TO '$USER_BANCO'@'localhost';"
...
cp $CONFIG_DIR/install/conf/settings.txt $CONFIG_DIR/cdrport/settings.py
