"""
Django settings for cdrport project.
...
SECRET_KEY = '%m=ljd@y5a06#=_&f0kii&-q4@8#4q)$sjg*+nrq$k^e#os(+0'
...
#STATICFILES_DIRS = ('/Users/eluizbr/Desktop/cdr-port-2.0/cdr-port/cdrport/',)
